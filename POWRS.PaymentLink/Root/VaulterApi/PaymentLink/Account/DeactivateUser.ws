...
try(
	...
	MailBody.Append("<br />");
	MailBody.Append("<br />Request to deactivate Legal identity on domen <strong><i>{{domen}}</i></strong> :");
	MailBody.Append("<br />");
	MailBody.Append("<br /><strong>User to be deactivated:</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Username: <strong>{{subUserName}}</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: <strong>{{subFirstLast}}</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <strong>{{subUserEmail}}</strong>");
	MailBody.Append("<br />");
	MailBody.Append("<br /><strong>Requested by:</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Username: <strong>{{clientUserName}}</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: <strong>{{clientFirstLast}}</strong>");
	MailBody.Append("<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <strong>{{clientUserEmail}}</strong>");
	MailBody.Append("<br />");
