...
(
	...
	CustomerEmail := GetSetting("POWRS.PaymentLink.FeeCalculatorCustomerEmail","");  
 ...
 POWRS.PaymentLink.MailSender.SendHtmlMail(Config.Host, Int(Config.Port), Config.Sender, Config.UserName, Config.Password, CustomerEmail, "PLG Contact ", html, null, null);
