        ...
        <div class="details">
            <div class="transaction-status">
				<div id="status" style="color:	#ffcc00; border-bottom:	#ffcc00 2px solid; padding-bottom:0;">
					 <h2 style="margin: 0.5em 0em;">Payment not performed.</h2>
				</div>
				<div id="description">
					<p>Hello ((BuyerName )), we are here to inform you that card registration for the product <i>((Title ))</i> performed by the company <i>((SellerName ))</i> is not performed.</p>
				</div></div>[[;
			if(CancellationReason == 'Buyer') then
			(
				]]<div class="try-again">
					<p><strong>((BuyerName )) initiated cancellation. If this is wrong please contact seller. </strong></p>
				<div>[[;
			)
			else if(CancellationReason == 'Seller') then 
			(
				]]<div class="try-again">
					<p><strong>((SellerName )) initiated cancellation. For more details contact seller directly. </strong></p>
				<div>[[;
			)
			else
			(
					]]<div class="try-again">
					<p><strong>This will usually happen when payment deadline expires. </strong></p>
				<div>[[;
			);	
        ]]</div>
		<div>
