        ...
        <div class="details">
            <div class="transaction-status">
				<div id="status" style="color:	#ffcc00; border-bottom:	#ffcc00 2px solid; padding-bottom:0;">
					 <h2 style="margin: 0.5em 0em;">((localization.Get("AwaitingCardRegistration") ))</h2>
				</div>
				<div>
					<p>((localization.GetFormat("AwaitingCardRegistrationBuyerMessage",BuyerName, SellerName, Link ) ))</p>
				</div>
			</div>
		</div>
		<div>
