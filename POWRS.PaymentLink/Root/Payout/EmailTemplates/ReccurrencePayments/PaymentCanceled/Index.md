        ...
        <div class="details">
            <div class="transaction-status">
				<div id="status" style="color:red; border-bottom: red 2px solid; padding-bottom:0;">
					 <h2 style="margin: 0.5em 0em;">Payment canceled.</h2>
				</div>
				<div id="description">
					<p>Hello ((BuyerName )), we are sad to inform you that automatic payments for the product <i>((Title ))</i> performed by the company <i>((SellerName ))</i> is canceled.</p>
				</div></div></div>
		<div>
		<P>Please note that the maximum number of retries is defined by the seller. 
		If the cancellation was not initiated by you, and you want to know more details about the contract itself, 
