...
function ExpandBuyerDetails() {
    ShowHideElement("buyerInfo", null);
    expand_img = document.getElementById("expand_img");
    expand_img.src = "../resources/expand-up.svg";
    expand_img.removeEventListener('click', ExpandBuyerDetails);
    expand_img.addEventListener("click", CollapseBuyerDetails);
}

function CollapseBuyerDetails() {
    ShowHideElement("buyerInfo", "none");
    expand_img = document.getElementById("expand_img");
    expand_img.src = "../resources/expand-down.svg";
    expand_img.removeEventListener('click', CollapseBuyerDetails);
    expand_img.addEventListener("click", ExpandBuyerDetails);
}
